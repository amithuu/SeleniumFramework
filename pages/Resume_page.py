...
class Resume(BaseDriver):
    ...
    NEXT = "//body/div[6]/div[3]/div//div//button[2]"
    BACK = "//body/div[6]/div[3]/div//div//button[1]"
    DOWNLOAD = "Download"
    POP_UP = "//body/div[6]/div[3]/div//button[1]"
    UPGRADE_BUTTON = "//body/div[6]/div[3]/div//div/div/div[2]//div//button"
    ...
    def get_resumeclick(self, i):
        return self.element_to_click(By.XPATH, f"//*[@id='root']/div[2]/div[2]/div/div/div[2]/div[{i}]/div")
